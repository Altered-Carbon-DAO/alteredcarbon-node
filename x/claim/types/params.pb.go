...
// source: alteredcarbon/claim/v1beta1/params.proto
...
func init() {
	proto.RegisterType((*ClaimAuthorization)(nil), "publicawesome.alteredcarbon.claim.v1beta1.ClaimAuthorization")
	proto.RegisterType((*Params)(nil), "publicawesome.alteredcarbon.claim.v1beta1.Params")
}

func init() {
	proto.RegisterFile("alteredcarbon/claim/v1beta1/params.proto", fileDescriptor_c219c2c72539a013)
}
