...
// source: alteredcarbon/claim/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgInitialClaim)(nil), "publicawesome.alteredcarbon.claim.v1beta1.MsgInitialClaim")
	proto.RegisterType((*MsgInitialClaimResponse)(nil), "publicawesome.alteredcarbon.claim.v1beta1.MsgInitialClaimResponse")
}

func init() { proto.RegisterFile("alteredcarbon/claim/v1beta1/tx.proto", fileDescriptor_9ee4a19153cf6635) }
...
func (c *msgClient) InitialClaim(ctx context.Context, in *MsgInitialClaim, opts ...grpc.CallOption) (*MsgInitialClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/publicawesome.alteredcarbon.claim.v1beta1.Msg/InitialClaim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_InitialClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publicawesome.alteredcarbon.claim.v1beta1.Msg/InitialClaim",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "publicawesome.alteredcarbon.claim.v1beta1.Msg",
	...
	Metadata: "alteredcarbon/claim/v1beta1/tx.proto",
}
