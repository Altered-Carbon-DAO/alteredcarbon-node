...
// source: alteredcarbon/claim/v1beta1/claim_record.proto
...
func init() {
	proto.RegisterEnum("publicawesome.alteredcarbon.claim.v1beta1.Action", Action_name, Action_value)
	proto.RegisterType((*ClaimRecord)(nil), "publicawesome.alteredcarbon.claim.v1beta1.ClaimRecord")
}

func init() {
	proto.RegisterFile("alteredcarbon/claim/v1beta1/claim_record.proto", fileDescriptor_8a75b9157744df4f)
}
