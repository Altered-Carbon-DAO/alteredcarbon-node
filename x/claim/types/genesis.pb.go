...
// source: alteredcarbon/claim/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "publicawesome.alteredcarbon.claim.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("alteredcarbon/claim/v1beta1/genesis.proto", fileDescriptor_cac1d615666a45cf)
}
